...
class DiscordAdapter(BasePlatformAdapter):
    ...
    async def _handle_message(self, message: DiscordMessage) -> None:
        ...
        if not is_thread and not isinstance(message.channel, discord.DMChannel):
            ...
            # Free-response channels bypass the mention gate, but should still
            # auto-thread by default so top-level channel posts become isolated
            # work threads. Only explicit no_thread_channels opt out of this
            # behavior.
